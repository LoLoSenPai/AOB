...
export const unitConfigs: Record<UnitType, UnitConfig> = {
  ...
  archer: {
    ...
    maxHealth: 55,
    speed: 50,
    cost: { food: 30, wood: 25 },
    population: 1,
    trainTicks: ticksFromSeconds(14),
    unlockedAge: "settlement",
    canGather: false,
    combat: {
      damage: 6,
      range: 112,
      cooldownTicks: ticksFromSeconds(1.25),
      aggroRange: 132,
    },
  },
  scout: {
    ...
    population: 1,
    trainTicks: ticksFromSeconds(16),
    unlockedAge: "settlement",
    canGather: false,
    combat: {
      damage: 7,
      range: 20,
      cooldownTicks: ticksFromSeconds(0.85),
      aggroRange: 116,
    },
  },
  goblin: {
